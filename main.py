...
if not partitioning: # Partitioning Eats up a lot of resources so we need to seperate these processes
    if testing:
        ...
        embeddings['articleID'] = embeddings['articleID'][:indices]
        embeddings['tensor'] = embeddings['tensor'][:indices]
        embeddings['unixTime'] = embeddings['unixTime'][:indices]
    ######################## Cleaning Data ########################
    ...
    # nltk.download('vader_lexicon') # TODO: Delete if not necessary.
